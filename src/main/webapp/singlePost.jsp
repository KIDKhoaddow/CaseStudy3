                    ...
                    <div class="col-10 col-sm-11">
                        <div class="single-post">
                            ...
                            <div class="post-thumb">
                                <img src="${post.getPostPicture()}" alt="Comming Soon">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta d-flex">
                                    ...
                                    <div class="post-comment-share-area d-flex">
                                        ...
                                        <div class="post-favourite">
                                            <a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i>${post.getPostLikes()}</a>
                                        </div>
                                        <!-- Post Comments -->
                                ...
                                <a href="#">
                                    <h2 class="post-headline">${post.getPostTitle()}</h2>
                                </a>
                        ...
                        <div class="comment_area section_padding_50 clearfix">
                            <h4 class="mb-30">${post.getPostComment()} Comments</h4>
                            <ol>
                                <!-- Single Comment Area -->
            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                <div class="blog-sidebar mt-5 mt-lg-0">
                    ...
                    <div class="single-widget-area about-me-widget text-center">
                        ...
                        <h4 class="font-shadow-into-light">${userName}</h4>
                    </div>
