...
<section class="welcome-post-sliders owl-carousel">
    ...
    <div class="welcome-single-slide">
        <!-- Post Thumb -->
        <img src="yummy-master/img/bg-img/slide-1.jpg" alt="">
        <!-- Overlay Text -->
    ...
    <div class="welcome-single-slide">
        <!-- Post Thumb -->
        <img src="yummy-master/img/bg-img/slide-2.jpg" alt="">
        <!-- Overlay Text -->
        <div class="project_title">
            <div class="post-date-commnents d-flex">
                <a href="#">May 19, 2017</a>
    ...
    <div class="welcome-single-slide">
        <!-- Post Thumb -->
        <img src="yummy-master/img/bg-img/slide-3.jpg" alt="">
        <!-- Overlay Text -->
        <div class="project_title">
            <div class="post-date-commnents d-flex">
                <a href="#">May 19, 2017</a>
    ...
    <div class="welcome-single-slide">
        <!-- Post Thumb -->
        <img src="yummy-master/img/bg-img/slide-4.jpg" alt="">
        <!-- Overlay Text -->
        <div class="project_title">
            <div class="post-date-commnents d-flex">
                <a href="#">May 19, 2017</a>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single_catagory wow fadeInUp" data-wow-delay=".3s">
                    <img src="yummy-master/img/catagory-img/1.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
                    <img src="yummy-master/img/catagory-img/2.jpg" alt="">
                    <div class="catagory-title">
                        <a href="#">
                            <h5>Cooking</h5>
                        </a>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single_catagory wow fadeInUp" data-wow-delay=".9s">
                    <img src="yummy-master/img/catagory-img/3.jpg" alt="">
                    <div class="catagory-title">
                        <a href="#">
                            <h5>Life Style</h5>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="single-post wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="post-thumb">
                                <img src="yummy-master/img/blog-img/1.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                ...
                                <a href="#">
                                    <h2 class="post-headline">Boil The Kettle And Make A Cup Of Tea Folks, This Is Going
                                        To Be A Big One!</h2>
                                </a>
                    ...
                    <div class="col-12">
                        <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".2s">
                            <!-- Post Thumb -->
                            <div class="post-thumb">
                                <img src="yummy-master/img/blog-img/6.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12">
                        <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".4s">
                            <!-- Post Thumb -->
                            <div class="post-thumb">
                                <img src="yummy-master/img/blog-img/7.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12">
                        <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".6s">
                            <!-- Post Thumb -->
                            <div class="post-thumb">
                                <img src="yummy-master/img/blog-img/8.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta d-flex">
                                ...
                                <a href="#">
                                    <h4 class="post-headline">Bristol's 10 Amazing Weekend Brunches And Late
                                        Breakfasts</h4>
                                </a>
                                <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                    quis nostrud exercitation</p>
                    ...
                    <div class="col-12">
                        <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".8s">
                            <!-- Post Thumb -->
                            <div class="post-thumb">
                                <img src="yummy-master/img/blog-img/9.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta d-flex">
                ...
                <div class="blog-sidebar mt-5 mt-lg-0">
                    ...
                    <div class="single-widget-area about-me-widget text-center">
                        ...
                        <div class="about-me-widget-thumb">
                            <img src="yummy-master/img/about-img/1.jpg" alt="">
                        </div>
                    ...
                    <div class="single-widget-area popular-post-widget">
                        ...
                        <div class="single-populer-post d-flex">
                            <img src="yummy-master/img/sidebar-img/1.jpg" alt="">
                            <div class="post-content">
                                <a href="#">
                        ...
                        <!-- Single Popular Post -->
                        <div class="single-populer-post d-flex">
                            <img src="yummy-master/img/sidebar-img/2.jpg" alt="">
                            <div class="post-content">
                                <a href="#">
                        ...
                        <!-- Single Popular Post -->
                        <div class="single-populer-post d-flex">
                            <img src="yummy-master/img/sidebar-img/3.jpg" alt="">
                            <div class="post-content">
                                <a href="#">
                        ...
                        <!-- Single Popular Post -->
                        <div class="single-populer-post d-flex">
                            <img src="yummy-master/img/sidebar-img/4.jpg" alt="">
                            <div class="post-content">
                                <a href="#">
                        ...
                        <!-- Single Popular Post -->
                        <div class="single-populer-post d-flex">
                            <img src="yummy-master/img/sidebar-img/5.jpg" alt="">
                            <div class="post-content">
                                <a href="#">
                    ...
                    <div class="single-widget-area add-widget text-center">
                        <div class="add-widget-area">
                            <img src="yummy-master/img/sidebar-img/6.jpg" alt="">
                            <div class="add-text">
